...
export const SunTornado: React.FC<Props> = ({ className }) => (
	<svg className={className} viewBox="0 0 2000 1500">
		<rect fill="#256592" width="2000" height="1500" />
		<defs>
			<radialGradient id="a" gradientUnits="objectBoundingBox">
				<stop offset="0" stop-color="#00143A" />
				<stop offset="1" stop-color="#256592" />
			</radialGradient>
			<linearGradient
				id="b"
